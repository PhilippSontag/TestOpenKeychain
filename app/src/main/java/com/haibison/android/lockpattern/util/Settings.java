...
public class Settings {
    ...
    public static final String genPreferenceFilename() {
        return String.format("%s_%s", com.haibison.android.lockpattern.util.Sys.LIB_NAME, com.haibison.android.lockpattern.util.Sys.UID);
    ...
    public static final String genDatabaseFilename(String name) {
        return String.format("%s_%s_%s", com.haibison.android.lockpattern.util.Sys.LIB_NAME, com.haibison.android.lockpattern.util.Sys.UID, name);
    }// genDatabaseFilename()
